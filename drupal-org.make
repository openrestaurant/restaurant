...
projects[restaurant_admin][download][url] = "http://git.drupal.org/project/restaurant_admin.git"
...
projects[restaurant_widgets][download][url] = "http://git.drupal.org/project/restaurant_widgets.git"
...
projects[restaurant_menu][download][revision] = 5c2783e
projects[restaurant_menu][download][branch] = 7.x-1.x
projects[restaurant_menu][subdir] = restaurant
projects[restaurant_menu][download][url] = "http://git.drupal.org/project/restaurant_menu.git"
...
projects[restaurant_slideshow][download][url] = "http://git.drupal.org/project/restaurant_slideshow.git"
...
projects[restaurant_reservation][download][revision] = 0247b52
...
projects[restaurant_seo][download][url] = "http://git.drupal.org/project/restaurant_seo.git"

projects[restaurant_location][type] = module
projects[restaurant_location][download][type] = git
projects[restaurant_location][download][revision] = c3df3c0
